...
if [ $# -gt 0 ] && [ $1 = "mpl_2" ]
then
    source /data/user/zgriffith/pev-photons/resources/venvs/mpl_2_env/bin/activate
elif [ $# -gt 0 ] && [ $1 = "trunk_skylab" ]
then
    source /data/user/zgriffith/pev-photons/resources/venvs/trunk_skylab/bin/activate
elif [ $# -gt 0 ] && [ $1 = "el7_photon_env" ]
then
    source /data/user/zgriffith/pev-photons/resources/venvs/el7_photon_env/bin/activate
else
    source /data/user/zgriffith/pev-photons/resources/venvs/photon_env/bin/activate
fi
