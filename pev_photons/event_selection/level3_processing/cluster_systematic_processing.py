...
if __name__ == "__main__":
    ...
    # Default parameters            
    outDir   = '/data/user/zgriffith/pev_photons/datasets/systematics/data/'+args.year
    ...
    if args.burn:
        ...
        dag_name    = '/data/user/zgriffith/dagman/myJobs/level3_systematic_processing_%s.dag' % args.year
    ...
    script = "/home/zgriffith/pev_photons/pev_photons/event_selection/level3_processing/systematic_data_processing.py"
